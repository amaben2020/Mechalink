DO $$ BEGIN
 CREATE TYPE "public"."mobileAppOs" AS ENUM('ios', 'android');
EXCEPTION
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "mechanics" ADD CONSTRAINT "mechanics_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
